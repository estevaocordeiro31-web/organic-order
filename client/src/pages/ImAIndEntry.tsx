...
const PARTNERS = [
  ...
  },
  {
    ...
    slug: "cabana",
    name: "Cabana Burger",
    tagline: "Top burgers for top moments ✌️",
    cuisine: "Gourmet Burgers",
    address: "Rua Barão de Teffé, 160 · Jundiaí",
    color: "#1a1200",
    accent: "#eab308",
    accentDark: "#ca8a04",
    gradient: "from-[#1a1200] via-[#2a1e00] to-[#1a1200]",
    cardBg: "from-[#2a1e00] to-[#1a1200]",
    ...
    available: true,
    route: "/cabana",
    heroImage: "https://d2xsxph8kpxj0f.cloudfront.net/310519663292442852/Evw5QZUwinvym6RWSTYRUE/cabana-hero-burger-EkJpkJJcBGiHHmJqMFfVeL.webp",
    badge: "🍔 Novo",
